...
# Native C compiler
CC_PC:=g++
CC_PC_FLAGS:=-W -Wall -DPC -I/usr/include/SDL2/ -lSDL2 -I $(SDK_DIR)/include-pc/ -L$(PC_SDK_DIR)/target/  -lsdk -lSDL2main
...
CC_WIN32_FLAGS:=-W -Wall -DWIN32 -DPC -I$(WIN32_SDL_DIR)/include -L$(WIN32_SDL_DIR)/lib -I$(PC_SDK_DIR)/include/ -L$(PC_SDK_DIR)/target/ -lsdk -lmingw32  -lSDL2 -lSDL2main
