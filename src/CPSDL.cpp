...
uint16_t *vram;  //The vram pointer (this is used by routines like setPixel and has to be initialized by getVramAddress() or calc_init();
...
bool Debug_PrintString(const char *string, bool invert) {
    // TODO: print also on screen
    Debug_Printf(g_x, g_y, invert, 0, string);
    return true;
}
...
//    printf("TODO getKey *%p *%p", key1, key2);
    *key1 = 0; *key2 = 0;
	SDL_PumpEvents();
